...
// describe('page d\'accueil visiteur', () => {
//   it('devrait afficher dans le navbar les boutons : Accueil, Menus, Se connecter, S\'inscrire', () => {
//     cy.visit('http://host.docker.internal:8000/'); // plus de host.docker.internal, on utilise baseUrl
//     cy.contains('Accueil'); // le bouton doit exister et être visible 
//     cy.contains('Menus'); // idem
...
//     cy.get('#id_menus').should('not.be.visible').click({ force: true });
//     // Décommente si tu veux vérifier la redirection
//     // cy.url().should('include', '/menus');
//   });
// });
